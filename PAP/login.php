...
if (isset($_GET['mensagem']) && $_GET['mensagem'] == 'senha_atualizada') {
	...
	<div class="warpper">
		<div class="form-box login">
			...
			<form method="post" action="verifica_login.php">
				...
				<button type="submit" value="Login" class="btn">Entrar</button>
				<div class="login-register">
					<p>Não tem uma conta?
						<a href="registro.php" class="register-link">Registo</a>
					</p>
				</div>
			</form>
		</div>
